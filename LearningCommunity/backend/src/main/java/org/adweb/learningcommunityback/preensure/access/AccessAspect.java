...
public class AccessAspect {
    ...
    public void ensureStudentHasCourseAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保学生%s是否有课程%s的权限", usernameList.toString(), courseCodeList.toString()));
    ...
    public void ensureStudentNotHasCourseAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保学生%s是否没有课程%s的权限", usernameList.toString(), courseCodeList.toString()));
    ...
    public void ensureTAHasCourseAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保助教%s是否有课程%s的权限", usernameList.toString(), courseCodeList.toString()));
    ...
    public void ensureTANotHasCourseAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保助教%s是否没有课程%s的权限", usernameList.toString(), courseCodeList.toString()));
    ...
    public void ensureTeacherHasCourseAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保教师%s是否有课程%s的权限", usernameList.toString(), courseCodeList.toString()));
    ...
    public void ensureTeacherHasChapterAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保教师%s是否有章%s的权限", usernameList.toString(), chapterIDList.toString()));
    ...
    public void ensureTeacherNotHasCourseAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保教师%s是否没有课程%s的权限", usernameList.toString(), courseCodeList.toString()));
    ...
    public void ensureUserHasCourseAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保用户%s是否有课程%s的权限", usernameList.toString(), courseCodeList.toString()));
        ...
        for (int i = 0; i < usernameList.size(); i++) {
            ...
            for (int j = 0; j < courseCodeList.size(); j++) {
                String courseCode = courseCodeList.get(j);
                Course course = courseRepository.findByCourseCode(courseCode);
    ...
    public void ensureUserHasChapterAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保用户%s是否有章%s的权限", usernameList.toString(), chapterIDList.toString()));
    ...
    public void ensureUserHasSectionAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保用户%s是否有小节%s的权限", usernameList.toString(), sectionIDList.toString()));
    ...
    public void ensureUserHasHomeworkAccess(JoinPoint point) {
        ...
        log.debug(String.format("尝试确保用户%s是否有作业%s的权限", usernameList.toString(), homeworkIDList.toString()));
