...
public class UserManagementController {
    ...
    @GetMapping("/otherAvatar")
    @PreAuthorize("hasAnyAuthority('Teacher') || hasAnyAuthority('TA') || hasAnyAuthority('Student')")
    public AvatarDTO getOtherAvatar(@RequestParam("username") String otherUsername,
                                    @AuthenticationPrincipal String username) {
        return userManagementService.getOtherAvatar(otherUsername, username);
    }
