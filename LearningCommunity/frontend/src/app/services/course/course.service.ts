...
export class CourseService {
  ...
  public getCourseMemberObservable(courseCode: string): Observable<HttpResponse<CourseMember[]>> {
    let interfaceUrl = '/courseMember'
    const myParams = new HttpParams().set("courseCode", courseCode);

    return this.http.get(
      this.commonService.getBackendUrlPrefix() + interfaceUrl,
      {headers: this.myHeaders, observe: 'response', params: myParams}) as Observable<HttpResponse<CourseMember[]>>
  }
